...
# Plot 3
plot(info[, dateTime], info[, Sub_metering_1], type="l", xlab="", ylab="Energy sub metering")
lines(info[, dateTime], info[, Sub_metering_2],col="red")
lines(info[, dateTime], info[, Sub_metering_3],col="blue")
legend("topright"
